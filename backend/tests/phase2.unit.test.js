...
describeIfDb("phase2 unit coverage", () => {
  ...
  test("legacy checkAchievement wrapper is a safe no-op for the slug-based catalog", async () => {
    ...
    await expect(checkAchievement(testPool, userId, "tap")).resolves.toEqual([]);
  });
