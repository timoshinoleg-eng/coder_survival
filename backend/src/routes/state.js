      ...
      res.json({
        ...
        progression: passiveProgression
          ? {
              ...
              onboardingCompleted: ['completed','skipped'].includes(passiveProgression?.onboarding_status),
              onboardingStatus: passiveProgression?.onboarding_status,
              onboardingCompletedAt: passiveProgression?.onboarding_completed_at ? new Date(passiveProgression.onboarding_completed_at).toISOString() : null,
              onboardingSkippedAt: passiveProgression?.onboarding_skipped_at ? new Date(passiveProgression.onboarding_skipped_at).toISOString() : null,
        ...
        game: {
          ...
          onboarding_completed: ['completed','skipped'].includes(passiveProgression?.onboarding_status),
          onboardingStatus: passiveProgression?.onboarding_status,
          onboardingCompletedAt: passiveProgression?.onboarding_completed_at ? new Date(passiveProgression.onboarding_completed_at).toISOString() : null,
          onboardingSkippedAt: passiveProgression?.onboarding_skipped_at ? new Date(passiveProgression.onboarding_skipped_at).toISOString() : null,
          inventory: passiveProgression.inventory || {},
