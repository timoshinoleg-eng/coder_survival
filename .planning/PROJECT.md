...
- [ ] Встроенный мемогенератор (5 шаблонов) с реальными игровыми переменными и шерингом в чат / Stories
...
- [ ] Случайные события каждые 30–90 секунд (прод упал, коллега прислал мем, +1 дедлайн, 404 sleep)
